  ...
  if( accountData !== null && typeof accountData === 'object' ) {
    ...
    return(
      ...
      <div className='grid grid-cols-12 h-full  py-3 '>
              ...
              {menuToggle &&
                  <div className="md:hidden text-black fixed w-full top-12 col-span-12 lg:col-span-6 z-20">
         ...
         {toggle === 'posts' && posts && !chatroomToggle &&
            ...
            <div className='mt-5 h-auto pb-3 bg-gray-100 text-gray-900  h-2/6 lg:hidden '>
              ...
              {accountLogin.accountData.id !== accountData.id &&
                ...
                <AddFriends accountData={accountData} handleChatroomToggle={handleChatroomToggle} senderID={accountLogin.accountData._id} getterID={accountData._id}/>
                </div>
              }
            </div>
            }
          ...
          posts.map((item,index)=>{
           return(
             ...
             <img className="bg-white rounded-full h-10 w-10 inline-block me-2 ms-2" src={item.accountImage} alt="Profile picture"/>
             </Link>
             </div>
             ...
             <div className="bg-white text-black flex flex-wrap border-t-2 col-span-12 mt-2 text-[1.0rem] font-semibold ">
                     <LikeSystem post={posts[index]} accountID={accountLogin.accountData.id} postID={item.postID} handleLike={handleLike}/>

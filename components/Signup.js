...
export default function Signup(props){
    ...
    <div>
        <div>
            ...
            <form className="sign-form-up overflow-auto" onSubmit={handleCreatingAccount} > 

                 <div className="py-2 px-3 self-end cursor-pointer" onClick={handleCancel}>X</div>
                 <div className=" m-2 my-5 bg-gray-200">
                    <button className="p-3 bg-black  text-white" disabled={true}> Sign Up</button>
                    <button className="p-3 bg-white text-black" onClick={handleToggle}> Sign In</button>
                 </div>

            <div className="bg-gray-200 flex flex-col w-5/6">

                <div className="bg-gray-200 text-black text-[2rem] mb-5 text-center">Sign Up</div>


                <div className="bg-gray-200 text-black w-full flex flex-col items-center">
                <label htmlFor="account-picture" className="cursor-pointer bg-gray-200 text-black" >
                ...
                <label className="bg-gray-200 text-black text-[1rem] self-start ms-1">Firstname</label>
                ...
                <div className="bg-gray-200 text-black text-[2rem] mb-2 text-center flex flex-col ">
                <label className="bg-gray-200 text-black text-[1rem] self-start ms-1">Lastname</label>
                ...
                <div className="bg-gray-200 text-black text-[2rem] mb-2 text-center flex flex-col ">
                <label className="bg-gray-200 text-black text-[1rem] self-start ms-1">Username</label>
                ...
                <p className={moreThan8?"text-[0.8rem] bg-gray-200 text-green-500":"text-[0.8rem] bg-gray-200 text-red-500"}>รหัสผ่านต้องมีจำนวน 8 ตัวขึ้นไป &nbsp;</p>
                <p className={includingChar?"text-[0.8rem] bg-gray-200 text-green-500":"text-[0.8rem] bg-gray-200 text-red-500"}> ประกอบด้วยตัวอักษร &nbsp;</p>
                <p className={inCludingInt?"text-[0.8rem] bg-gray-200 text-green-500":"text-[0.8rem] bg-gray-200 text-red-500"}>ประกอบด้วยตัวเลข</p>
                </div>
                </div>

                <div className="bg-gray-200 text-black text-[2rem] mb-2 text-center flex flex-col ">
                <label className="bg-gray-200 text-black text-[1rem] self-start ms-1">Password Confirm</label>

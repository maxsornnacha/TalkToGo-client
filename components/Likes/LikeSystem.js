...
export default function LikeSystem(props){
    ...
    useEffect(()=>{
            ...
            const likeGet = props.post.likes
    ...
    const handleLike=(event)=>{
        ...
        if(like === 0){
            ...
            .then(()=>{
                //console.log('like เพิ่ม 1 สำเร็จ ')
            })
            .catch(()=>{
                //console.log('Like เพิ่ม 1 ล้มเหลว')
            })
            ...
            .then(()=>{
                //console.log('like ลบ 1 สำเร็จ ')
            })
            .catch(()=>{
                //console.log('Like ลบ 1 ล้มเหลว')
            })
        }

...
export default function LikeSystem(props){
    ...
    return(
    <>
    <button value={like} onClick={handleLike} className={like===1?"bg-white  flex-1 text-[0.8rem]  text-yellow-500 h-full py-3":"bg-wwhite text-black flex-1 text-[0.8rem] py-3"}>ถูกใจ</button>
    </>
    )
}
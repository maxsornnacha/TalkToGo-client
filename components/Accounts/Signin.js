    ...
    <div>
        <div>
            ...
            <form className="sign-form-in" onSubmit={handleSubmitForm}> 
                <div className="flex  w-full">
                 <div className=" m-2 my-5 w-4/6 text-end">
                    <button className="p-3 bg-white shadow-md text-black" onClick={handleToggle}> Sign Up</button>
            ...
            <div className=" flex flex-col w-5/6">
                ...
                <div className=" text-black text-[2rem] mb-5 text-center">Sign In</div>
                

                <div className=" text-black text-[2rem] mb-2 text-center flex flex-col ">

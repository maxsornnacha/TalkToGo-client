...
export default function Reply(props){
    ...
    <div className="w-full">
        ...
        <div className="py-2 w-full border-t mt-2 flex flex-col">
                ...
                <textarea placeholder='เขียนความคิดเห็น...' onChange={(event)=>setReplyInput(event.target.value)} rows={replyInput && replyInput.length>170?7:1} value={replyInput} className="w-full p-3 bg-gray-100 w-full outline-none text-[0.8rem] rounded-md"/>

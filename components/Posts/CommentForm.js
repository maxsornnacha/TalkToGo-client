    ...
    <div>  
        ...
        <form className="comment-form z-50">
            ...
            <div className="h-screen w-full overflow-auto">
                ...
                <p className="text-[0.9rem]">{props.post.firstname} {props.post.lastname}</p>
                </div>
                
                <div className="px-5 py-2 text-[0.9rem]">
                    {props.post.content}
                </div>
                ...
                <div className="pt-3 bg-white text-black col-span-12 flex flex-row justify-between items-center mx-5 border-b border-gray-300 pb-5">
                 ...
                 <p className="bg-white text-black font-seimibold  text-[0.9rem] ">{props.like} Likes</p>
                 </div>
                 <span className="bg-white text-black text-[0.9rem]">
                     {commentData?commentData.length:0} <span className="bg-white text-black text-[0.9rem] cursor-pointer" onClick={()=>{}}>ความคิดเห็น</span>
                 </span>            
                 </div>
                ...
                { commentData.map((commentItem,index)=>{
                    return(
                    <div className="flex flex-row gap-2 mt-5 text-[0.9rem] flex-wrap" key={index}>
                        <div>
                        ...
                        <div className="w-80 flex flex-col gap-1">
                            ...
                            <div className="text-[0.75rem] flex gap-3">
                            ...
                            <div className="text-[0.75rem] flex flex-col">
            ...
            <div className="py-2 w-full border-t mt-2 flex flex-col">
                ...
                <textarea placeholder='เขียนความคิดเห็น...' onChange={(event)=>setCommentInput(event.target.value)} rows={commentInput && commentInput.length>170?7:2} value={commentInput} className="p-3 bg-gray-100 w-full outline-none text-[0.9rem] rounded-md"/>

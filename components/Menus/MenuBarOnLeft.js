...
export default function MenuBarOn(props){
    ...
    return(
    <>
    <div className="flex flex-col items-start my-6  text-gray-300 font-medium bg-gray-800 rounded-md">
        ...
        <img src="/homeMenu.png" alt="home" className="h-full w-10 cursor-pointer pb-3 me-2"/>
        ...
        <img src="/friendMenu.png" alt="home" className="h-full w-10 cursor-pointer pb-3 me-2"/>
        ...
        <img src="/talkroomMenu.png" alt="home" className="h-full w-10 cursor-pointer pb-3 me-2"/>
        <button className="w-full text-start text-[1.0rem]">
            ห้องสำหรับพูดคุย
        </button>
        </Link>

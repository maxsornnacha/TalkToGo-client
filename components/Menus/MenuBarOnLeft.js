...
export default function MenuBarOn(props){
    ...
    return(
    <>
    <div className="flex flex-col items-start my-6  text-black font-medium bg-gray-100 rounded-md">
        
        <div className="flex w-full p-2 hover:bg-yellow-200 hover:text-black font-medium hover:text-black font-medium hover:rounded-md">
        ...
        <div className="flex w-full p-2 hover:bg-yellow-200 hover:text-black font-medium hover:rounded-md">
